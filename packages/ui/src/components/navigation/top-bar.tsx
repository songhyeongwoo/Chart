...
export function TopBar({ title, subtitle, actions }: TopBarProps) {
  return (
    <div className="sticky top-0 z-10 border-b border-line-subtle/80 bg-[linear-gradient(180deg,rgba(252,249,244,0.96),rgba(243,238,230,0.94))] px-6 py-5 backdrop-blur">
      <div className="flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
        <div>
          <p className="text-caption font-medium uppercase tracking-[0.24em] text-ink-3">Workspace</p>
          <h2 className="mt-2 text-[1.55rem] font-semibold tracking-[-0.04em] text-ink-1">{title}</h2>
