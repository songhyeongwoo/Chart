...
export function RightInspectorShell({
  ...
  return (
    <aside className="workspace-shell flex h-full min-h-[680px] flex-col overflow-hidden rounded-[30px] border border-line-strong shadow-[0_30px_84px_rgba(18,20,18,0.12)] xl:sticky xl:top-24 xl:max-h-[calc(100vh-7rem)]">
      <div className="border-b border-line-subtle/80 px-5 py-5">
        ...
        <div className="mt-4 grid grid-cols-2 gap-2 xl:grid-cols-3">
          {normalizedTabs.map((tab) => {
            ...
            const tabClasses = cn(
              "rounded-[18px] border px-3 py-3 text-left transition-all duration-200 ease-refined",
              isActive
