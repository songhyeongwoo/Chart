...
const variantClassName: Record<ButtonVariant, string> = {
  ...
  secondary:
    "border border-line-strong bg-surface-1/96 text-ink-1 hover:-translate-y-0.5 hover:bg-surface-2 focus-visible:ring-accent-soft",
  tertiary:
...
export function Button({
  ...
  return (
    <button
      className={cn(
        "inline-flex items-center justify-center gap-2 rounded-md font-medium tracking-[-0.012em] transition-all duration-200 ease-refined focus-visible:outline-none focus-visible:ring-2 disabled:cursor-not-allowed disabled:opacity-45",
